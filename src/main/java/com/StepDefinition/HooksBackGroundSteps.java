...
public class HooksBackGroundSteps {
	...
	public void user_is_already_is_login_Page()  {
	    // Write code here that turns the phrase above into concrete actions	
		 ...
		 System.out.println("Launch Free CRM");
	    
	}
	
	/*@Before("@Contacts")
	public void deleteExitingContact()
	{ System.out.println("Before COntact");
		driver.switchTo().frame("mainpanel");
		WebElement linkContacts=driver.findElement(By.xpath("//a[contains(text(),'Contacts')]"));
		linkContacts.click();
		driver.findElement(By.xpath("//a[text()='Nayeem John']//following::i[@title='Delete'][1]")).click();
		driver.switchTo().alert().accept();
	}
	
	@After("@Deals")
	public void deleteExitingDeals()
	{ System.out.println("After Deals");
		driver.switchTo().frame("mainpanel");
		WebElement linkDeal=driver.findElement(By.xpath("//a[contains(text(),'Deals')]"));
		linkDeal.click();
		driver.findElement(By.xpath("//a[text()='10002']//following::i[@title='Delete'][1]")).click();
		driver.switchTo().alert().accept();
	}*/
	@After
